...
export const EditorPickSection: React.FC = () => {
  ...
  return (
    <section className="w-full bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 border-y border-amber-500/20 py-10 px-4 sm:px-8 my-8 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 pb-4 border-b border-amber-500/30 mb-8">
          <div>
            <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-amber-500/10 border border-amber-500/30 text-amber-400 text-[11px] font-brand font-bold uppercase tracking-widest mb-2 shadow-sm">
              <Award className="w-3.5 h-3.5" />
              <span>Editor's Selection</span>
            </div>
            <h2 className="font-editorial text-2xl sm:text-3xl md:text-4xl font-bold text-slate-100">
          ...
          <div className="text-xs text-amber-400/90 font-medium tracking-wide">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {editorPicks.map((article: Article, idx: number) => (
            <article
              ...
              className="group cursor-pointer rounded-2xl bg-gradient-to-b from-slate-900/90 to-slate-950/90 border border-amber-500/20 hover:border-amber-500/50 shadow-xl hover:shadow-2xl hover:shadow-amber-500/5 transition-all duration-300 flex flex-col justify-between overflow-hidden"
            >
              <div>
                {/* Visual Header */}
                <div className="relative aspect-[16/10] w-full overflow-hidden bg-slate-900">
                  ...
                  <div className="absolute top-3 left-3 flex items-center gap-2">
                    <span className="w-6 h-6 rounded-full bg-amber-500 text-slate-950 text-xs font-black flex items-center justify-center font-brand">
                      {idx + 1}
                    </span>
                ...
                {/* Body Content */}
                <div className="p-5">
                  <h3 className="font-editorial text-lg sm:text-xl font-bold text-slate-100 group-hover:text-amber-300 transition-colors leading-snug">
                    {article.title}
                  </h3>

                  <p className="font-sans text-xs sm:text-sm text-slate-400 mt-2.5 line-clamp-3 leading-relaxed">
              ...
              <div className="px-5 pb-5 pt-3 border-t border-slate-800/80 flex items-center justify-between text-xs text-slate-400">
                ...
                <div className="flex items-center gap-1.5 text-amber-400/90 font-medium text-[11px] group-hover:translate-x-1 transition-transform">
