        ...
        <div className="flex flex-col sm:flex-row gap-3 mt-6">
          <div className="relative flex-1">
            ...
            <input 
              ...
              className="w-full pl-10 pr-4 py-2.5 rounded-xl bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-800 text-slate-900 dark:text-slate-100 text-xs focus:outline-none focus:border-blue-600 shadow-sm"
            />
          </div>
          ...
          <select
            ...
            className="px-3.5 py-2.5 rounded-xl bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-800 text-slate-800 dark:text-slate-200 text-xs focus:outline-none focus:border-blue-600 shadow-sm"
          >
            {sectors.map(s => (
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {filteredLeaders.map((leader: BusinessLeader) => (
          <div
            ...
            className="group cursor-pointer rounded-3xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 hover:border-blue-500/50 p-6 flex flex-col justify-between shadow-sm hover:shadow-md dark:shadow-xl transition-all duration-300"
          >
            <div>
              <div className="flex items-center gap-4">
                <img 
                  src={leader.avatar} 
                  alt={leader.name}
                  className="w-20 h-20 rounded-2xl object-cover border-2 border-slate-200 dark:border-slate-700 group-hover:border-blue-500 transition-colors shrink-0 shadow-sm"
                ...
                <div className="min-w-0">
                  ...
                  <h3 className="font-editorial text-xl font-bold text-slate-900 dark:text-slate-100 group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors truncate">
                    {leader.name}
                  </h3>
              ...
              {leader.quote && (
                <div className="mt-3 p-3 rounded-xl bg-slate-50 dark:bg-slate-950/70 border-l-2 border-amber-500 dark:border-amber-400 text-xs text-slate-700 dark:text-slate-300 italic font-editorial">
                  "{leader.quote}"
                </div>
              )}
            </div>
